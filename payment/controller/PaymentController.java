...
import com.rentmate.service.payment.pay.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<?> createOwner(@RequestParam String name, @RequestParam String email) throws StripeException {
        Stripe.apiKey = stripeKey;
        User user = new User();
        user.setName(name);
        user.setEmail(email);
